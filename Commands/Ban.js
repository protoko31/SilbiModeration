...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (!member || !sebep) return message.channel.send(embed.setDescription(`${message.member}, Hatalı kullanım. Örnek: **${ayar.bot.botPrefix}ban @Etiket/ID [Reason]**`)).sil(7)
...
exports.config = {
    name: "ban",
    usage: `${ayar.bot.botPrefix}ban [@Etiket/ID] [reason]`,
    guildOnly: true,
    aliases: [],
    cooldown: 3000
};