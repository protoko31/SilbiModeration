...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (!member) return message.channel.send(embed.setDescription(`${message.member}, Hatalı kullanım örnek: **${ayar.bot.botPrefix}git @Etiket/ID**`)).sil(7);
...
exports.config = {
    name: "çek",
    usage: `${ayar.bot.botPrefix}çek [@Etiket/ID]`,
    guildOnly: true,
    aliases: ["cek"],
    cooldown: 3000
};